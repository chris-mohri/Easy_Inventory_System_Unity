// GENERATED AUTOMATICALLY FROM 'Assets/Game Folder/Scripts/PlayerControls.inputactions'
    ...
    public struct MouseActions
    {
        ...
        public void SetCallbacks(IMouseActions instance)
        {
            if (m_Wrapper.m_MouseActionsCallbackInterface != null)
            {
                ...
                @LeftHold.started -= m_Wrapper.m_MouseActionsCallbackInterface.OnLeftHold;
                @LeftHold.performed -= m_Wrapper.m_MouseActionsCallbackInterface.OnLeftHold;
                @LeftHold.canceled -= m_Wrapper.m_MouseActionsCallbackInterface.OnLeftHold;
